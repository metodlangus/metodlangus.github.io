(function (window) {
    ...
    let initSpeed, maxSpeed, minSpeed, stepSpeed, initQuality, SLIDESHOW_HIDDEN, SLIDESHOW_VISIBLE, randomizeImages, defaultImgSrc_png, defaultImgSrc, doubleClickThreshold, title, WindowBaseUrl;
 ...
 */
                ...
                for (let entry of entries) {
                    if (slideshowTitles[index] !== "Make trip slideshow") {
                        ...
                        if (entry.content && entry.content.$t) {
                            ...
                            const postTitle = title || entry.title?.$t || "Untitled Post"; // Use input title if available, otherwise entry title
    ...
    */
    function processEntry(index, entry) {
        ...
        const postTitle = title || entry.title.$t;
    ...
    */
    function refreshAutoHide(index) {
        ...
        slideshows[index].hideTimeout = setTimeout(() => navigationControl[index].style.display = 'none', 2500);
    }
    ...
    */
    ...
    function init(userConfig = {}) {
        ...
        numberOfSlideshows.forEach(index => {
            ...
            sliderContainer[index].addEventListener('mouseenter', () => {
                clearTimeout(slideshows[index].hideTimeout);
                navigationControl[index].style.display = 'flex';
            });
