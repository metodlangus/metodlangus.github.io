...
function initMap() {
    if (mapInitialized) return; // Prevent multiple initializations
    mapInitialized = true;

    document.getElementById('map').style.display = "block"; // Show the map
    document.getElementById('map-title').style.display = "block"; // Show the title
    document.getElementById('map-settings').style.display = "block"; // Show settings of the map
...
// Event listener to trigger map initialization
function loadMapOnInteraction() {
    window.removeEventListener('scroll', loadMapOnInteraction);
    window.removeEventListener('mousemove', loadMapOnInteraction);
    initMap();
...
window.addEventListener('mousemove', loadMapOnInteraction, { once: true });