...
PATTERNS = {
    ...
    "skip_indexing_and_geotag_photos" : "rrrrrrrrrrrrrrsssrrrs",  # skip indexing and geotaging photos
}
...
if __name__ == "__main__":
    ...
    run_section(21, "Update extracted_relive_photos_with_gps_data.txt",
