...
OUTPUT_DIR = Path.cwd() / "relive"
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
SITEMAP_FILE = "sitemap.xml"
LASTMOD_DB = Path(".build/lastmod.json")
BASE_FEED_PATH = f"{LOCAL_REPO_PATH }/data/all-relive-posts.json"
...
KEY_LOCATION = f"{BASE_BLOG_URL}/{KEY}.txt"
        ...
        <div class="pages">
          <aside class='sidebar-pages'>
            ...
            <ul>
              ...
              <li><a href="{BASE_BLOG_URL}/seznam-vrhov/">Seznam vrhov</a></li>
              <li><a href="{BASE_BLOG_URL}/zemljevid-spominov/">Zemljevid spominov</a></li>
              <li><a href="{BASE_BLOG_URL}/uporabne-povezave/">Uporabne povezave</a></li>
              <li><a href="{BASE_BLOG_URL}/o-strani/">O strani</a></li>
            </ul>
          </aside>
        </div>
        {settings_html}
...
<head>
  ...
  <script>window.BLOG_CONTEXT = {{isRelive: true}};</script>
...
<head>
  ...
  <meta property="og:url" content="{BASE_BLOG_URL}/o-strani/" />
  <meta property="og:type" content="website" />

  <title>O strani | {BLOG_TITLE} | {BLOG_AUTHOR}</title>

  <!-- Canonical & hreflang -->
  <link rel="canonical" href="{BASE_BLOG_URL}/o-strani/" />
  <link rel="alternate" href="{BASE_BLOG_URL}/o-strani/" hreflang="sl" />
  <link rel="alternate" href="{BASE_SITE_URL}/" hreflang="x-default" />
...
def generate_peak_list_page():
  ...
  {{
    ...
    "@type": "WebPage",
    "name": "Seznam vrhov",
    "url": "{BASE_BLOG_URL}/seznam-vrhov/",
...
<head>
  ...
  <meta property="og:url" content="{BASE_BLOG_URL}/seznam-vrhov/" />
  <meta property="og:type" content="website" />

  <title>Seznam vrhov | {BLOG_TITLE}</title>

  <!-- Canonical & hreflang -->
  <link rel="canonical" href="{BASE_BLOG_URL}/seznam-vrhov/" />
  <link rel="alternate" href="{BASE_BLOG_URL}/seznam-vrhov/" hreflang="sl" />
  <link rel="alternate" href="{BASE_SITE_URL}/" hreflang="x-default" />
...
def generate_big_map_page():
  ...
  {{
    ...
    "url": "{BASE_BLOG_URL}/zemljevid-spominov/",
...
<head>
  ...
  <meta property="og:url" content="{BASE_BLOG_URL}/zemljevid-spominov/" />
  <meta property="og:type" content="website" />

  <title>Zemljevid spominov | {BLOG_TITLE}</title>

  <!-- Canonical & hreflang -->
  <link rel="canonical" href="{BASE_BLOG_URL}/zemljevid-spominov/" />
  <link rel="alternate" href="{BASE_BLOG_URL}/zemljevid-spominov/" hreflang="sl" />
  <link rel="alternate" href="{BASE_SITE_URL}/" hreflang="x-default" />
...
def generate_home_en_page(homepage_html):
  ...
  {{
    ...
    "potentialAction": {{
      "@type": "SearchAction",
      "target": "{BASE_BLOG_URL}/en/search?q={{search_term_string}}",
      "query-input": "required name=search_term_string"
    }}
  }}
  </script>"""
...
<head>
  ...
  <link rel="canonical" href="{BASE_BLOG_URL}/en/" />
  ...
  <meta property="og:url" content="{BASE_BLOG_URL}/en/" />
  <meta property="og:type" content="website" />
...
<body>
  <div class="custom-404-page">
    <div class="background-404-page">
      <div class="centered-404-page">
        <div class="quarter-404-page">
          <div class="message-overlay-404-page">
            <h1>404</h1>
...
PATTERNS = {
    ...
    "skip_indexing_and_geotag_photos" : "rrrrrrrrrrrrrrrsssrrrs",  # skip indexing and geotaging photos
}
...
if __name__ == "__main__":
    # 0.1 Update relive base file: relive_data.txt
    ...
    run_section(1, "Create feeds",
        lambda: subprocess.run(["python", "get_relive_feeds.py"], check=True),
    ...
    # 18. Update list_of_relive_tracks.txt
    run_section(19, "Update list_of_relive_tracks.txt",
        lambda: subprocess.run(["python", "generate_relive_track_list.py"], check=True),
        pattern_iter=pattern_iter)

    # 19. Update relive photos content
    run_section(20, "Update relive photos content",
        lambda: subprocess.run(["node", "get_relive_photos_content.js"], check=True),
        pattern_iter=pattern_iter)

    # 20. Update relive data-skip attributes
    run_section(21, "Update relive data-skip attributes",
        lambda: subprocess.run(["python", "update_relive_data-skip_atributes.py"], check=True),
        pattern_iter=pattern_iter)
    ...
    run_section(22, "Update extracted_relive_photos_with_gps_data.txt",
        lambda: subprocess.run(["python", "appned_relive_location_to_photos.py"], check=True),
        pattern_iter=pattern_iter)