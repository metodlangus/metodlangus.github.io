...
phone_directory = "/storage/0123-4567/DCIM/Camera23"
disk_directory = ""
# -----------------------------------------------------------
# # Disk directory
...
def main():
    list_of_photos_file = os.path.join(BASE_DIR, "list_of_relive_photos.txt")  # The file containing the image names and links
    images_folder = directory  # Update the path with raw string notation
    output_file = os.path.join(BASE_DIR, "extracted_relive_photos_with_gps_data.txt")  # The file to save the extracted GPS coordinates and UTC times
